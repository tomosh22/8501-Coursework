...
public:
	...
	result run_experimental(std::vector<int>* input, const float* xOffset);
protected:
	...
	void calculate_remaining_coeffs_experimental(int* terms, const int* highorder, std::vector<int>* set, const float* xOffset);
